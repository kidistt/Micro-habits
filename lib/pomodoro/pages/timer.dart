...
class _TimerState extends State<MyTimer> {
  ...
  String currentSong = 'music/50.mp3';
                        ...
                        children: [
                          const SizedBox(
                              width:
                                  50), // Add some horizontal spacing to align the text with the first message
                          Text(
                            'You study ${_sessionCount * _timeInt} minutes.',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            icon: const Icon(Icons.restart_alt,
                color: Color.fromARGB(255, 225, 181, 181), size: 30),
            onPressed: () {
              setState(() {
                _resetTimer();
              });
      ...
      floatingActionButton: FloatingActionButton(
        ...
        mini: false,
        child: _isRunning
            ? const Icon(Icons.pause, color: Color.fromARGB(255, 225, 181, 181))
          ...
          children: [
            DropdownButton<String>(
              ...
              onChanged: (String? newValue) async {
                ...
                await audioPlayer.setAsset(newValue!);
              ...
              children: [
                Container(
                  ...
                  child: CircularProgressIndicator(
                    color: const Color.fromARGB(255, 225, 181, 181),
                    backgroundColor: Colors.black,
